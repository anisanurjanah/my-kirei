<div class="modal fade" id="{{ $menu->slug }}-price-edit" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="modal-title fs-6">
                    Perbarui Potongan Harga:<span class="fw-bold ms-2">{{ $menu->name }}</span>
                </h2>
                        ...
                        <form method="post" action="{{ getModuleFormAction('prices', optional($menu->pricePromo)->id) }}">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control @error('price_promo') is-invalid @enderror" id="price_promo" name="price_promo" value="{{ number_format((int) old('price_promo', optional($menu->pricePromo)->price_promo), 0, ',', '.') }}" autocomplete="off" required>
                                </div>
                                @error('price_promo')
