                ...
                orders.map((order) => (
                    <div className="mt-4 flex items-center justify-center">
                        <button
                            ...
                            className="w-xl text-left cursor-pointer rounded-[10px] border border-gray-200 my-1"
                        >
                            <div className="relative rounded-[10px] px-4 py-4">
                                <span
                                    className="absolute -top-px -right-px rounded-bl-2xl bg-[#F5F5F5]
                                        p-2 md:px-6 md:py-4 text-xs md:text-md tracking-wide text-[#333]"
                                >
                                    { order.outlet.name }
                                </span>
                                <time
